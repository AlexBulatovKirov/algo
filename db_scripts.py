...
def add_links():
    ...
    while answer != 'n':
        quiz_id = int(input("id викторины(от 1 до 3): "))
        question_id = int(input("id вопроса(от 1 до 6): "))
...
def check_answer(q_id, ans_text): ### вся функция
    query = '''
...
def main():
    ...
    add_links()
    show_tables()
    # Вывод в консоль вопроса с id=0, id викторины = 1
